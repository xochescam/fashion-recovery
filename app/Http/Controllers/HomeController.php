...
class HomeController extends Controller
{
    ...
    
    {
        $items = DB::table('fashionrecovery.GR_029')
                    ...
                    ->select('GR_029.ItemID','GR_032.ItemPictureID','GR_032.PicturePath','GR_031.Discount','GR_029.OriginalPrice','GR_029.ActualPrice','GR_020.SizeName','GR_018.ColorName','GR_017.BrandName')
                    ->get()
                    ->groupBy('ItemID');
