...
class SearchController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $products = DB::table('fashionrecovery.GR_029')
            ...
            ->select('fashionrecovery.GR_029.ItemDescription', 'GR_029.ItemID','GR_032.ItemPictureID','GR_032.PicturePath','GR_032.ThumbPath',
                'GR_029.OriginalPrice','GR_029.ActualPrice','GR_020.SizeName','GR_018.ColorName','GR_017.BrandName')
