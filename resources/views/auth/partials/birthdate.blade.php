    ...
    <div class="form-row" >
      <div class="col-3">
        <select id="birth_date[]" class="form-control" name="birth_date[]">
          ...
          <option value="1" {{ old('birth_date')[0] == '1' || (isset($birthDay) && $birthDay == '01') ? 'selected' : ''}}>1</option>
          <option value="2" {{ old('birth_date')[0] == '2' || (isset($birthDay) && $birthDay == '02')? 'selected' : ''}}>2</option>
          <option value="3" {{ old('birth_date')[0] == '3' || (isset($birthDay) && $birthDay == '03')? 'selected' : ''}}>3</option>
          <option value="4" {{ old('birth_date')[0] == '4' || (isset($birthDay) && $birthDay == '04') ? 'selected' : ''}}>4</option>
          <option value="5" {{ old('birth_date')[0] == '5' || (isset($birthDay) && $birthDay == '05')? 'selected' : ''}}>5</option>
          <option value="6" {{ old('birth_date')[0] == '6' || (isset($birthDay) && $birthDay == '06')? 'selected' : ''}}>6</option>
          <option value="7" {{ old('birth_date')[0] == '7' || (isset($birthDay) && $birthDay == '07')? 'selected' : ''}}>7</option>
          <option value="8" {{ old('birth_date')[0] == '8' || (isset($birthDay) && $birthDay == '08')? 'selected' : ''}}>8</option>
          <option value="9" {{ old('birth_date')[0] == '9'  || (isset($birthDay) && $birthDay == '09') ? 'selected' : ''}}>9</option>
