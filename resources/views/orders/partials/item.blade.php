			...
			<div class="card-body">
				<h5 class="card-title">
					...
					@if(isset($item->FolioID) && $order->Name !== 'Cancelado')
						<a href="{{ 'http://'.$item->TrackingURL }}" target="_blank" rel="noopener noreferrer" class="btn btn-outline-green btn-sm float-right d-none d-sm-block" role="button" aria-pressed="true">
							Rastrear pedido
						</a>
					@endif
				</h5>
