            ...
            <div class="card">
              ...
              <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="card-body">
                  ...
                  <p class="mb-3"> <b>¿Hay política de devoluciones?</b> </p>
                  ...
                  <p class="mb-3"><b>¿Qué hago si otro usuario me molesta?</b></p>
                  <p class="ml-0 ml-md-4">
                  ...
                  <p class="mb-3"><b>¿Es seguro comprar?</b></p>
                  <p class="ml-0 ml-md-4">
                  ...
                  <p class="mb-3"><b>¿Es seguro vender?</b></p>
                  <p class="ml-0 ml-md-4">
                    Tu seguridad es la mayor prioridad para nosotros. Nuestra plataforma es totalmente segura, no guardamos ni almacenamos los datos de pago como el número de la tarjeta de crédito/débito.
                  </p>
                  <p class="ml-0 ml-md-4">
                  ...
                  <p class="mb-3"><b>¿Están mis datos seguros?</b></p>
                  <p class="ml-0 ml-md-4">
            ...
            <div class="card">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                <div class="card-body">
                  ...
                  <p class="mb-3"><b>Usos inapropiados de Fashion Recovery</b></p>
                  <p class="ml-0 ml-md-4">
                  ...
                  <p class="mb-3"><b>Normas de nuestra Comunidad</b></p>
                  <p class="ml-0 ml-md-4">
                  ...
                  <p class="mb-3"><b>¿Qué es SPAM y qué comentarios no están permitidos en la comunidad?</b></p>
                  <p class="ml-md-4">
