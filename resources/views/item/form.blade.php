...
{{--   <div class="custom-file">
  ...
  <div class="row js-items-container mt-2 text-center">
    ...
    <div class="col-sm-4 mb-5 thumb-size js-item-picture">
      <input type="file" name="cover_item_file" id="cover_item_file" class="no-file js-item-file custom-file-input" data-type="Portada" data-name="cover" accept="image/*" capture="camera" required>
    ...
    <div class="col-sm-4 mb-5 thumb-size js-item-picture">
      <input type="file" name="front_item_file" id="front_item_file" class="no-file js-item-file custom-file-input" data-type="Foto frontal" data-name="front" accept="image/*" capture="camera" required>
    ...
    <div class="col-sm-4 mb-5 thumb-size js-item-picture">
      <input type="file" name="label_item_file" id="label_item_file" class="no-file js-item-file custom-file-input" data-type="Foto de la etiqueta" data-name="label" accept="image/*" capture="camera" required>
    ...
    <div class="col-sm-4 mb-5 thumb-size js-item-picture">
      <input type="file" name="back_item_file" id="back_item_file" class="no-file js-item-file custom-file-input" data-type="Foto de espaldas" data-name="back" accept="image/*" capture="camera" required>
    ...
    <div class="col-sm-4 mb-5 thumb-size js-item-picture">
      <input type="file" accept="image/*" capture="camera" name="selfie_item_file" id="selfie_item_file" class="no-file js-item-file custom-file-input" data-type="Selfie" data-name="selfie">
    ...
    <div class="col-sm-4 mb-5 thumb-size js-item-picture">
      <input type="file" name="in_item_file" id="in_item_file" class="no-file js-item-file custom-file-input" data-type="Prenda puesta" data-name="in" accept="image/*" capture="camera">
