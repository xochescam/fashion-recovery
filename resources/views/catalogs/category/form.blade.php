  ...
  <div class="form-group">
    ...
    <div class="form-group">
      <div class="form-check">
          <input class="form-check-input is-invalid" type="checkbox" id="active" name="active" value="{{ (isset($category->Active) && $category->Active) ? 'true' : 'false'  }}" {{ isset($category->Active) ? ($category->Active == 1 ? 'checked' : '' ) : 'checked'}}>
