	            ...
	            <tr>
	                <td width="700" valign="top">
                        ...
                        <p style="line-height: 25px; color: #444;font: 300 15px sans-serif;text-align: center; margin-bottom: 30px; margin-top: 20px;">
							Tu solicitud de devolución con motivo de <b>{{ $rason }}</b> ha sido <b>{{ $type == 'true' ? 'pre-aprobada.' : 'cancelada.' }} </b> <br>
							{{ $type == 'true' ? 'Ingresa a mis pedidos para ver el seguimiento de la prenda.' : '' }}
                        </p>
