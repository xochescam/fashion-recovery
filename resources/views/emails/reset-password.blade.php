...
@section('content')
	...
	<tr>
	    <td width="620" valign="top" style="background-color:#f7f7f7; text-align: center;">
            ...
            <a href="https://www.fashionrecovery.com.mx/{{$token}}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); color: #FFF; display: inline-block; text-decoration: none; -webkit-text-size-adjust: none; background-color: #009c77; border-top: 10px solid #009c77; border-right: 18px solid #009c77; border-bottom: 10px solid #009c77; border-left: 18px solid #009c77;">Restablecer contraseña</a>
