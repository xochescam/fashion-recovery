          ...
          @foreach($wishlists as $wishlist)
            ...
            <div class="col-sm-4 mb-4">
              ...
              <div class="card card--public card--public card--item">
                ...
                <div class="card-body">
                  <h5 class="card-title mb-0"> {{ $wishlist['NameList'] }} </h5>
              
                  <div class="edit-closet">
                    <small class="text-left align-middle"> {{ isset($wishlist['Items']) ? count($wishlist['Items']) : '0' }} prenda{{ isset($wishlist['Items']) && count($wishlist['Items']) > 1 ? 's': '' }}</small>
                    <a class="card-link float-right" href="#" data-toggle="modal" data-target="#updateWishlist-{{ $wishlist['WishListID'] }}"><i class="fas fa-pencil-alt"></i></a>
                  </div>
                </div>
<!-- 
                <div class="card-body">
